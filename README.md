...
🔗 **GitHub**: [https://github.com/vochicuongg/QuanLyChiTieu_Android](https://github.com/vochicuongg/QuanLyChiTieu_Android)
...
| :--- | :--- |
| **Flutter SDK** (Dart) | **firebase_auth** (Đăng nhập) |
| **fl_chart** (Biểu đồ) | **cloud_firestore** (Database) |
| **flutter_local_notifications** | **firebase_core** |
...
| Dashboard (Dark) | Statistics (Pie) |
| :---: | :---: |
| *(Thêm ảnh tại đây)* | *(Thêm ảnh tại đây)* |

| Comparison (Bar) | Settings |
| :---: | :---: |
| *(Thêm ảnh tại đây)* | *(Thêm ảnh tại đây)* |
...
© 2026 VFinance. All Rights Reserved.